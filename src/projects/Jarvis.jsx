    ...
    <div className="container-famili">
      ...
      >
        <div className="col-md-6">
          <img src={Khedmat} alt="" className="familishop h-12 md:h-40 w-12 md:w-40" />

          <h1>Jarvis </h1>
          <p>
            Jarvis, a forward-thinking tech startup, empowers users to achieve
            their project goals within set timeframes by addressing common
            hurdles like motivation, overthinking, and time management. We
            achieve this through user behavior tracking and a sophisticated NLP
            model with reinforcement learning, tailoring individualized work
            plans. The platform offers roadmap visualization, fosters a
            collaborative user community, facilitates project management,
            provides data-driven insights, and employs push notifications to
            keep users on track. Jarvis is your partner in turning ambitions
            into successful project outcomes while optimizing your productivity.
          </p>
        </div>
