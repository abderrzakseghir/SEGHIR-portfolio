  ...
  return (
    <div className='container-famili'>
     ...
     <div className='col-xxl-5 col-md-6'>
      <h1>PRIGRA </h1>
      <p>"Prigra is a web and mobile platform designed to track and manage projects of the form "Diploma-Stratup/Diploma-Patent" following the guidelines of the Ministry of Higher Education and Scientific Research (Ministerial Order 1275).

Key features:

• Project submission capability for students.
• Tracking and scheduling of project presentations by the establishment's internship service.
• Projects validation by the establishment's incubator.
• Effective collaboration tools between project holders and supervisors.
• Availability of project evaluations and deliberations on the platform.
• Push notification service through the mobile app.</p>
     </div>
